...
5. Add to `.env.local`:
   ...
   # Lead Magnet Resource Forms (one per resource type)
   NEXT_PUBLIC_HUBSPOT_RESOURCE_ROI_FORM_ID=5421c5dd-9cfb-4a89-bc06-6681300dca8e
   NEXT_PUBLIC_HUBSPOT_RESOURCE_COMPARISON_FORM_ID=your-comparison-form-id
   NEXT_PUBLIC_HUBSPOT_RESOURCE_DEPLOYMENT_FORM_ID=your-deployment-form-id
   NEXT_PUBLIC_HUBSPOT_RESOURCE_TECHNICAL_FORM_ID=9f3e2d38-d131-492f-a4df-410b16aeac42
   NEXT_PUBLIC_HUBSPOT_RESOURCE_COMPLIANCE_FORM_ID=your-compliance-form-id
   NEXT_PUBLIC_HUBSPOT_RESOURCE_OPERATIONS_FORM_ID=your-operations-form-id
   ```
