...
export default function TAKCalloutSection() {
  ...
  const benefits = [
    ...
    { key: 'asiaPacific', title: t('benefits.asiaPacific.title'), description: t('benefits.asiaPacific.description') },
    { key: 'aiEnhanced', title: t('benefits.aiEnhanced.title'), description: t('benefits.aiEnhanced.description') },
    { key: 'uptime', title: t('benefits.uptime.title'), description: t('benefits.uptime.description') }
  ];
