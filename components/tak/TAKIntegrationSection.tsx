          ...
          <div className="space-y-6">
            ...
            <div className="tactical-border bg-white/5 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {t.raw('useCases.military.tags').map((tag: string, index: number) => (
                    <span key={index} className="text-xs font-mono text-tactical-accent bg-black/30 px-2 py-1 rounded">{tag}</span>
                  ))}
                </div>
              </div>
            </div>
            ...
            <div className="tactical-border bg-white/5 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {t.raw('useCases.lawEnforcement.tags').map((tag: string, index: number) => (
                    <span key={index} className="text-xs font-mono text-tactical-accent bg-black/30 px-2 py-1 rounded">{tag}</span>
                  ))}
                </div>
              </div>
            ...
            <div className="tactical-border bg-white/5 overflow-hidden">
              ...
              <div className="p-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {t.raw('useCases.emergency.tags').map((tag: string, index: number) => (
                    <span key={index} className="text-xs font-mono text-tactical-accent bg-black/30 px-2 py-1 rounded">{tag}</span>
                  ))}
                </div>
              </div>
