...
export default function TAKIntegrationSection() {
  const t = useTranslations('takPage.integration');
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="space-y-6">
              {(t.raw('benefits') as Array<{ number: string; title: string; description: string }>).map((benefit, index) => (
            ...
            <div className="tactical-border bg-white/5 overflow-hidden">
              <div className="relative h-48 overflow-hidden">
                <img
                  ...
                  alt={t('useCases.military.imageAlt')}
            ...
            <div className="tactical-border bg-white/5 overflow-hidden">
              <div className="relative h-48 overflow-hidden">
                <img
                  ...
                  alt={t('useCases.lawEnforcement.imageAlt')}
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-tactical-bg to-transparent"></div>
              </div>
            ...
            <div className="tactical-border bg-white/5 overflow-hidden">
              <div className="relative h-48 overflow-hidden">
                <img
                  ...
                  alt={t('useCases.emergency.imageAlt')}
                  className="w-full h-full object-cover"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-tactical-bg to-transparent"></div>
              </div>
